...
class Rectangle:
    """Eni, hündürlüyü və sayğacı olan bir düzbucaqlı klası"""

    number_of_instances = 0

    def __init__(self, width=0, height=0):
        """Yeni bir Rectangle obyekti yaradır və sayğacı artırır"""
        self.width = width
        self.height = height
    ...
    def __del__(self):
        """Obyekt silinəndə sayğacı azaldır və mesaj çap edir"""
        Rectangle.number_of_instances -= 1
        print("Bye rectangle...")
